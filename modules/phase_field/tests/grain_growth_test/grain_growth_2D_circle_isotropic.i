...
[Materials]
  [./CuGrGr]
    # Material properties
    type = GBQuadrantTest # Quantitative material properties for copper grain growth.  Dimensions are nm and ns
...
[Outputs]
  file_base = circle_2D_isotropic
  output_initial = true
  exodus = true
  csv = true
  print_perf_log = true
  output_timestep_end = true
